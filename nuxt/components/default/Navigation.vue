...
<template>
    <div class="navigation cg3vi cax03 c5e9s cadmo cqmvi csb3e cxxfw c9cru c70js cfydh c5zj3">
        <div class="cpk71 co9go c9hv0 c0bc4 cglmn cfwvb">
            <div class="cew4t">
                <div class="cst8n cfwvb cfup8" v-if="showAvatar">
                    <nuxt-link to="/">
                        <img class="c3iz2" :src="avatar" width="32" height="32" alt="Me" />
                    </nuxt-link>
                </div>
            </div>
            <div class="c5a0p cew4t cfwvb c4a0m">
                <nav class="c8pgj">
                    <ul class="c9gi4">
                        <li class="cgktm">
                            <nuxt-link class="c5c77 c4ugg csbvt cpvt7 cfup8 crnoq c5a0p c8pgj cfwvb cq87d" to="/">
                        ...
                        <li class="cgktm">
                            <nuxt-link class="c5c77 c4ugg csbvt cpvt7 cfup8 crnoq c5a0p c8pgj cfwvb cq87d" to="/about">
                        ...
                        <li class="cgktm">
                            <nuxt-link class="c5c77 c4ugg csbvt cpvt7 cfup8 crnoq c5a0p c8pgj cfwvb cq87d" to="/resume">
                        ...
                        <li class="cgktm">
                            <nuxt-link class="c5c77 c4ugg csbvt cpvt7 cfup8 crnoq c5a0p c8pgj cfwvb cq87d"
                                to="/subscribe">
    ...
    <div class="navigation-mobile hidden w-full">
        <ul class="flex justify-around items-center h-full">
            ...
            <li class="cgktm">
                <nuxt-link class="c5c77 c4ugg csbvt cpvt7 cfup8 crnoq c5a0p c8pgj cfwvb cq87d" to="/about">
                    <svg class="cjnrq" xmlns="http://www.w3.org/2000/svg" width="20" height="20">
                        <path fill-opacity=".16" d="M10 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8Z"></path>
                        <path
                            d="M9 5h2v2H9V5Zm0 4h2v6H9V9Zm1-9C4.48 0 0 4.48 0 10s4.48 10 10 10 10-4.48 10-10S15.52 0 10 0Zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8Z">
                        </path>
                    </svg>
            ...
            <li class="cgktm">
                <nuxt-link to="/resume" class="c5c77 c4ugg csbvt cpvt7 cfup8 crnoq c5a0p c8pgj cfwvb cq87d">
                    <svg class="cjnrq" xmlns="http://www.w3.org/2000/svg" width="18" height="20">
                        <path fill-opacity=".16" fill-rule="nonzero" d="M1 5h16v14H1z"></path>
                        <path fill-rule="nonzero" d="M2 6v12h14V6H2Zm16-2v16H0V4h18ZM2 2V0h14v2H2Z"></path>
                    </svg>
            ...
            <li class="cgktm">
                <nuxt-link class="c5c77 c4ugg csbvt cpvt7 cfup8 crnoq c5a0p c8pgj cfwvb cq87d" to="/subscribe">
                    <svg class="cjnrq" xmlns="http://www.w3.org/2000/svg" width="21" height="21">
                        <path fill-opacity=".16" d="m13.4 18-3-7.4-7.4-3L19 2z"></path>
                        <path
                            d="M13.331 15.169 17.37 3.63 5.831 7.669l5.337 2.163 2.163 5.337Zm-3.699-3.801L.17 7.53 20.63.37l-7.161 20.461-3.837-9.463Z">
